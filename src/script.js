...
function generatePoem(event) {
  ...
  let prompt =
    "You are poem expert. Write a short four line poem according to the user instructions in basic HTML and seperate the lines with </br>. Do not include the title .";
