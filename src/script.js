...
function generatePoem(event) {
  ...
  let prompt =
    "You are poem expert. Write a short four line poem according to the user instructions in basic HTML with each sentence on its own line. Do not include the title .";
